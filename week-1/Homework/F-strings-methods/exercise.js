...
var message = `Mi nombre es ${nombre} y mi nombre tiene ${nombreLongitud} caracteres de longitud`; // agrego el valor de la variable

console.log(message); // imprimo en pantalla el valor de message
